...
class _Home20SearchArticlesWidgetState
  ...
  void initState() {
    ...
    _model.textController ??= TextEditingController(text: 'All');
                        ...
                        builder: (context) => ClipRRect(
                          ...
                          child: Image.network(
                            valueOrDefault<String>(
                              currentUserPhoto,
                              'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/mobile-qwpwdt/assets/w0xuhb47aarr/Group_6_(2).png',
                            ),
                            width: 300.0,
                            height: 200.0,
                            fit: BoxFit.cover,
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Where is your next Gala?...',
                    ...
                    children: [
                      Padding(
                        ...
                        child: FlutterFlowChoiceChips(
                          options: [
                            ChipData('All'),
                            ChipData('Condominiums'),
                            ChipData('Hotels'),
                            ChipData('Apartments'),
                            ChipData('Resorts'),
                            ChipData('Recreations')
                          ],
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://images.unsplash.com/photo-1618773928121-c32242e63f39?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxob3RlbHxlbnwwfHx8fDE3Mzk2MDIzNDJ8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                    width: 120.0,
                                    height: 120.0,
                                    fit: BoxFit.cover,
                                  ),
